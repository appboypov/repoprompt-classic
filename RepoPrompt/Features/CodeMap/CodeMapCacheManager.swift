...
struct CodeMapContentFingerprint: Codable, Equatable, Sendable {
...
class CodeMapCacheManager {
	...
	func loadRootFolderCacheAsync(rootFolderPath: String) async -> CodeMapCacheRootFolder? {
		...
		let currentVersion = self.currentCacheVersion
	...
	@discardableResult
	public func saveRootFolderCache(_ rootFolderPath: String, rootEntry: CodeMapCacheRootFolder) -> Bool {
