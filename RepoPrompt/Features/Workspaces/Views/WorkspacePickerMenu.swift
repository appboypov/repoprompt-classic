...
struct WorkspacePickerMenu<Label: View>: View {
	...
	private var menuMinWidth: CGFloat { fontPreset.scaledClamped(200, max: 280) }
	private var menuIdealWidth: CGFloat { fontPreset.scaledClamped(220, max: 300) }
	private var menuMaxHeight: CGFloat { fontPreset.scaledClamped(300, max: 440) }
	private var rowMinHeight: CGFloat { fontPreset.scaledClamped(26, min: 26, max: 36) }
	...
	private var itemSpacing: CGFloat { fontPreset.scaledClamped(2, max: 4) }
	private var menuPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var dividerPadding: CGFloat { fontPreset.scaledClamped(5, max: 8) }
	private var cornerRadius: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var checkmarkColumnWidth: CGFloat { fontPreset.scaledClamped(16, max: 22) }
	private var rowSpacing: CGFloat { fontPreset.scaledClamped(8, max: 12) }
