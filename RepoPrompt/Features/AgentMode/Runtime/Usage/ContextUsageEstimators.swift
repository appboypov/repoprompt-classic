...
enum ContextUsageSnapshotSource: String, Codable, Equatable, Sendable {
...
enum ContextUsageSnapshotConfidence: String, Codable, Equatable, Sendable {
	case exact
	case bestEffort
	case inferred
}

struct ContextUsageSnapshot: Codable, Equatable, Sendable {
	var used: Int?
	var window: Int?
...
protocol ContextUsageEstimating: AnyObject {
	var agent: DiscoverAgentKind { get }
