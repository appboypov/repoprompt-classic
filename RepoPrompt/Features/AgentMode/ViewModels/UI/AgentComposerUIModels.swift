...
struct AgentStagedSlashCommandProps: Equatable, Sendable {
	enum Kind: Equatable, Sendable {
		case codexGoal
	}

	enum GoalAction: String, Equatable, Sendable {
		case setObjective
		case show
		case pause
		case resume
...
struct AgentRunCancelTarget: Equatable, Sendable {
	let tabID: UUID
...
struct AgentComposerSubmitTarget: Equatable, Sendable {
