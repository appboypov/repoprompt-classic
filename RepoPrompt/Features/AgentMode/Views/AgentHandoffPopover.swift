...
struct AgentHandoffPopover: View {
	...
	@State private var selectedAgent: DiscoverAgentKind
	...
	private var popoverWidth: CGFloat { fontPreset.scaledClamped(340, max: 460) }
	...
	private var availableAgents: [DiscoverAgentKind] {
	...
	@ViewBuilder
	private func handoffModelMenuContent(for agent: DiscoverAgentKind) -> some View {
	...
	private func selectHandoffModel(_ model: AgentModelOption, for agent: DiscoverAgentKind) {
		selectedAgent = agent
