...
private struct AgentWindowFocusedEnvironmentKey: EnvironmentKey {
	static let defaultValue = true
}

extension EnvironmentValues {
	var agentWindowIsFocused: Bool {
		get { self[AgentWindowFocusedEnvironmentKey.self] }
		set { self[AgentWindowFocusedEnvironmentKey.self] = newValue }
	}
}
...
struct AgentMessageBubble: View {
	...
	var body: some View {
		...
		case .toolResult:
			if isHiddenAgentTool(item.toolName) {
				...
				ContextBuilderResultCard(item: item, context: contextBuilderContext)
			} else {
	...
	private func codexGoalModeBadge(_ metadata: AgentCodexGoalModeMetadata, hasWorkflow: Bool) -> some View {
		let labelText: String = {
			...
			case .setObjective:
				return hasWorkflow ? "/goal context" : "/goal"
			case .show:
				return "/goal show"
			case .pause:
				return "/goal pause"
		...
		let tooltip: String = {
			...
			case .setObjective where hasWorkflow:
				return "This message set a Codex goal. The selected workflow was applied as goal context, not as a separate user turn."
			case .setObjective:
				return "This message set a Codex goal."
			case .show, .pause, .resume, .clear:
				return "Codex goal control command."
			}
		}()
	...
	private var legacyTranscriptSummaryLines: (primary: String, secondary: String)? {
		...
		guard joined.contains("tool called")
			...
			|| joined.contains("hidden tool calls") else {
			return nil
		}
	...
	private func toolIconName(for toolName: String?) -> String {
		switch toolName {
		case "ask_user_question", "ask_user": return "questionmark.circle"
		case "read_file": return "doc.text"
		case "apply_edits": return "pencil"
		case "file_actions": return "doc.badge.plus"
		case "file_search": return "magnifyingglass.circle"
		case "get_file_tree": return "folder"
		case "get_code_structure": return "list.bullet.indent"
		case "manage_selection": return "checkmark.circle"
		case "workspace_context": return "square.stack.3d.up"
		case "ask_oracle", "oracle_send": return "brain"
		case "oracle_utils": return "brain.head.profile"
		case "chat_send": return "bubble.left.and.bubble.right"
		case "context_builder": return "sparkles"
	...
	private func toolDisplayName(for toolName: String?) -> String {
		switch toolName {
		case "ask_user_question", "ask_user": return "User Question"
		case "read_file": return "Read File"
		case "apply_edits": return "Edit File"
		case "file_actions": return "File Action"
		case "file_search": return "Search"
		case "get_file_tree": return "File Tree"
		case "get_code_structure": return "Code Structure"
		case "manage_selection": return "Selection"
		case "workspace_context": return "Context"
		case "ask_oracle", "oracle_send": return "Oracle"
		case "oracle_utils": return "Oracle Utils"
		case "chat_send": return "Chat"
		case "context_builder": return "Context Builder"
	...
	private func shouldShowFullArgs(toolName: String?) -> Bool {
		...
		case "read_file", "get_file_tree":
			return false // Path shown inline
		case "manage_selection":
			return true // Show full args to see paths
		default:
			return true
		}
	}
	...
	private func toolResultIconName(for toolName: String?) -> String {
		switch toolName {
		case "ask_user_question", "ask_user": return "questionmark.circle.fill"
		case "read_file": return "doc.text.fill"
		case "apply_edits": return "checkmark.circle.fill"
		case "file_search": return "magnifyingglass"
		case "get_file_tree": return "folder.fill"
		case "get_code_structure": return "list.bullet.indent"
		case "ask_oracle", "oracle_send", "chat_send": return "sparkles"
	...
	private func toolResultDisplayName(for toolName: String?) -> String {
		switch toolName {
		case "ask_user_question", "ask_user": return "User Question"
		case "read_file": return "File Content"
		case "apply_edits": return "Edit Result"
		case "file_search": return "Search Results"
		case "get_file_tree": return "File Tree"
		case "get_code_structure": return "Code Structure"
		case "manage_selection": return "Selection Updated"
		case "ask_oracle", "oracle_send": return "Oracle Response"
		case "oracle_utils": return "Oracle Result"
		case "chat_send": return "Chat Response"
		case let name?: return "\(name) Result"
	...
	private func previewLineCount(for toolName: String?) -> Int {
		switch toolName {
		case "ask_user_question", "ask_user": return 5
		case "apply_edits": return 20 // Show more for diffs
		case "read_file": return 15
		case "file_search": return 15
		case "get_file_tree": return 25
		case "get_code_structure": return 20
		default: return 10
		}
	}
}
...
struct AgentAssistantLineDerivation {
...
private struct TaggedFilesBadge: View {
	...
	private var label: String {
		...
		default:
			return "+\(attachments.count) files attached"
		}
	}
}
