...
struct AgentWorkflowsPopoverView: View {
	...
	private var sectionContentPadding: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var rowVerticalSpacing: CGFloat { fontPreset.scaledClamped(2, max: 3) }
	private var rowHorizontalPadding: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var rowVerticalPadding: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var rowGroupSpacing: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var rowCornerRadius: CGFloat { fontPreset.scaledClamped(6, max: 8) }
	private var titleDescriptionSpacing: CGFloat { fontPreset.scaledClamped(2, max: 3) }
	private var rowIconTopPadding: CGFloat { fontPreset.scaledClamped(1, max: 2) }
	private var hiddenChevronSpacing: CGFloat { fontPreset.scaledClamped(4, max: 6) }
	private var hiddenChevronVerticalPadding: CGFloat { fontPreset.scaledClamped(3, max: 5) }
	private var customSectionTopPadding: CGFloat { fontPreset.scaledClamped(4, max: 6) }
	private var sectionHeaderVerticalPadding: CGFloat { fontPreset.scaledClamped(2, max: 3) }
	private var clearButtonSpacing: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var footerSpacing: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var footerInnerSpacing: CGFloat { fontPreset.scaledClamped(4, max: 6) }
	private var footerControlHorizontalPadding: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var footerControlVerticalPadding: CGFloat { fontPreset.scaledClamped(6, max: 9) }
