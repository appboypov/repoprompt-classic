...
struct AgentSidebarPopoverLinkRow: View {
	...
	private var outerSpacing: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var titleDetailSpacing: CGFloat { fontPreset.scaledClamped(1, max: 2) }
	private var horizontalPadding: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var verticalPadding: CGFloat { fontPreset.scaledClamped(5, max: 8) }
	private var leadingIconSize: CGFloat { fontPreset.scaledClamped(11, max: 14) }
	private var leadingIconFrameWidth: CGFloat { fontPreset.scaledClamped(14, max: 18) }
	private var chevronSize: CGFloat { fontPreset.scaledClamped(9, max: 12) }
