...
struct AgentModeSessionsSidebarView: View {
	...
	private var searchHorizontalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var searchVerticalPadding: CGFloat { fontPreset.scaledClamped(6, max: 9) }
	private var searchCornerRadius: CGFloat { fontPreset.scaledClamped(16, max: 20) }
	private var searchControlHeight: CGFloat { fontPreset.scaledClamped(30, min: 30, max: 40) }
	private var searchIconSize: CGFloat { fontPreset.scaledClamped(14, max: 18) }
	private var searchClearIconSize: CGFloat { fontPreset.scaledClamped(12, max: 16) }
	private var topBarSpacing: CGFloat { fontPreset.scaledClamped(4, max: 6) }
	private var topBarHorizontalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var topBarVerticalPadding: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var collapseButtonHitSize: CGFloat { min(max(24, searchControlHeight), 32) }
	...
	/// Search box for filtering sessions (matches FileTreeView styling)
...
struct AgentModeSessionsListView: View {
	...
	@ObservedObject private var fontScale = FontScaleManager.shared
	private var fontPreset: FontScalePreset { fontScale.preset }
	private var listRowSpacing: CGFloat { fontPreset.scaledClamped(2, max: 3) }
	private var listHorizontalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var showMoreHorizontalPadding: CGFloat { fontPreset.scaledClamped(10, max: 14) }
	private var showMoreVerticalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var dividerVerticalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var archivedHeaderSpacing: CGFloat { fontPreset.scaledClamped(8, max: 11) }
	private var archivedHeaderHorizontalPadding: CGFloat { fontPreset.scaledClamped(10, max: 14) }
	private var archivedHeaderBottomPadding: CGFloat { fontPreset.scaledClamped(4, max: 6) }
...
private struct AgentSidebarDateSectionHeader: View {
	...
	@ObservedObject private var fontScale = FontScaleManager.shared
	private var fontPreset: FontScalePreset { fontScale.preset }
	private var horizontalPadding: CGFloat { fontPreset.scaledClamped(10, max: 14) }
	private var topPadding: CGFloat { isFirst ? fontPreset.scaledClamped(2, max: 3) : fontPreset.scaledClamped(14, max: 20) }
	private var bottomPadding: CGFloat { fontPreset.scaledClamped(4, max: 6) }
...
enum AgentSidebarDateSectionBucket: CaseIterable, Hashable, Identifiable, Sendable {
	case today
	case yesterday
	case previous
...
struct ArchivedSessionsPagedList: View {
	...
	private var fontPreset: FontScalePreset { fontScale.preset }
	private var rowSpacing: CGFloat { fontPreset.scaledClamped(2, max: 3) }
	private var showMoreHorizontalPadding: CGFloat { fontPreset.scaledClamped(10, max: 14) }
	private var showMoreVerticalPadding: CGFloat { fontPreset.scaledClamped(8, max: 12) }
	private var topPadding: CGFloat { fontPreset.scaledClamped(4, max: 6) }
