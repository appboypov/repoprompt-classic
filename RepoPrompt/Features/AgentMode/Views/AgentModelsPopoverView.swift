...
struct AgentModelsPopoverView: View {
	...
	private var popoverWidth: CGFloat { fontPreset.scaledClamped(360, max: 520) }
	private var popoverMaxHeight: CGFloat { fontPreset.scaledClamped(680, max: 820) }
	private var roleLabelWidth: CGFloat { fontPreset.scaledClamped(64, max: 86) }
	...
	private var hasRoleOverrides: Bool {
		roleResolutions.contains(where: { $0.hasCustomOverride })
	}
