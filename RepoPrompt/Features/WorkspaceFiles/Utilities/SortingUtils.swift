...
enum SortMethod: String, CaseIterable {
	...
	var displayName: String {
		...
		case .extensionAscending: return "Extension (A–Z)"
		case .extensionDescending: return "Extension (Z–A)"
		case .dateNewest: return "Date (Newest)"
		case .dateOldest: return "Date (Oldest)"
		case .tokenAscending: return "Tokens (Low–High)"
		case .tokenDescending: return "Tokens (High–Low)"
		}
	}
}
...
func sortFolderItems(
	...
	return folderItems.sorted { lhs, rhs in
		switch (lhs, rhs) {
