...
struct ChatPresetsSettingsView: View {
	...
	private var headerSection: some View {
		VStack(alignment: .leading, spacing: 4) {
			...
			Text("Reusable presets for RepoPrompt's built-in chat UI. Each preset bundles a chat mode, optional model selection, code-map / file-tree / git-diff options, and stored-prompt selections. These don't affect Agent Mode.")
				.font(.subheadline)
    ...
    private func duplicatePresetData(_ preset: ChatPreset) -> ChatPreset {
...
private struct ChatPresetEditView: View {
    ...
    private var titleText: String {
        switch editMode {
        case .createCustom:
            return "Create Chat Preset"
        case .editCustom:
            return "Edit Chat Preset"
        case .builtInOverrides:
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    section(title: "Chat Mode") {
                        Picker("Mode", selection: $mode) {
                            ...
                            Text("Edit").tag(ChatPresetMode.edit)
							Text("Pro Edit").tag(ChatPresetMode.proEdit)
                        }
