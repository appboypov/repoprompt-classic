...
struct AgentPermissionsSettingsView: View {
	...
	init(
		...
		self._diagnosticsVM = StateObject(wrappedValue: resolvedDiagnostics)
		...
		self._providerVM = StateObject(wrappedValue: resolvedProvider)
		...
		self._subagentVM = StateObject(wrappedValue: resolvedSubagent)
	}
