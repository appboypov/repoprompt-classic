...
"""
	...
	var allPrompts: [ContextBuilderPrompt] { builtInPrompts + prompts }
	...
	private func setBuiltInPinned(_ isPinned: Bool, for id: UUID) {
		...
		let storedIDs = builtInPinnedPromptIDs.map { $0.uuidString }
...
struct ContextBuilderPromptsOverlay: View {
	...
	private var panelWidth: CGFloat { 480 * fontPreset.scaleFactor }
	private var panelMaxHeight: CGFloat { 450 * fontPreset.scaleFactor }
...
struct ContextBuilderPromptsButton: View {
	...
	private var selectedCount: Int {
		...
		selectedPromptIDs.filter { id in
