...
private struct OperationPermissionRow: View {
    ...
    private var operationDescription: String {
        ...
        case .createWorkspace:
            return "Allow creating new workspaces"
        case .deleteWorkspace:
            return "Allow deleting existing workspaces"
        case .addFolder:
            return "Allow adding folders to workspaces"
        case .removeFolder:
            return "Allow removing folders from workspaces"
        }
    }
}
