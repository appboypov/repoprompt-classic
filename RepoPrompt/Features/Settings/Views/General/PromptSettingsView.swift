...
struct PromptSettingsView: View {
    ...
    // Model settings
    @AppStorage("allowDiffModelsToRewrite") private var allowDiffModelsToRewrite: Bool = true
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 12) {
                ...
                SettingSection(
                    ...
                    description: "Configure model behavior for AI responses"
                ) {
                    SettingToggle(
