...
struct BenchmarkTaskSummary: Codable, Identifiable, Sendable {
	let id: String
	let type: String
	let pass: Bool
	let score: Double
...
struct BenchmarkSeedSummary: Codable, Identifiable, Sendable {
	let seed: UInt32
	let passRate: Double
...
struct BenchmarkTypeSummary: Codable, Identifiable, Sendable {
	let type: String
	let passRate: Double
	let averageScore: Double
	let count: Int
...
struct BenchmarkRunSummary: Codable, Identifiable, Sendable {
	let id: UUID
	let timestamp: Date
...
struct BenchmarkLeaderboardEntry: Identifiable, Sendable {
	let modelRawValue: String
	let modelDisplayName: String
	let runs: Int
	let totalTasks: Int
