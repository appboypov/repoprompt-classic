...
enum AgentTextDerivationPerfDiagnostics {
	...
	private static func eventName(for source: Source) -> String {
		switch source {
		case .assistantCollapseCheck:
			return "transcript.lineDerivation.assistantCollapseCheck"
		case .assistantPreview:
			return "transcript.lineDerivation.assistantPreview"
		case .toolResultPreview:
			return "transcript.lineDerivation.toolResultPreview"
		case .diffPreview:
			return "transcript.lineDerivation.diffPreview"
		case .collapsibleCodeBlock:
			return "transcript.lineDerivation.collapsibleCodeBlock"
		case .scrollableCodeHeight:
			return "transcript.lineDerivation.scrollableCodeHeight"
		case .toolResultJSONPrettyPrint:
			return "transcript.prettyPrintJSON.toolResult"
		}
	}
