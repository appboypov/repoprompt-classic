...
public struct GitRepoDescriptor: Codable, Sendable, Equatable, Hashable {
	...
	public init(rootURL: URL) {
		...
		self.rootPath = (rootURL.path as NSString).standardizingPath
		self.displayName = rootURL.lastPathComponent
		self.repoKey = Self.makeRepoKey(for: self.rootPath, displayName: self.displayName)
	}
