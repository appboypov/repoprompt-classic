...
internal enum GitDiffPatchParsing {
	...
	internal struct TruncationResult: Sendable {
		internal let files: [ParsedFileHunks]
	...
	internal static func parseHunks(from patchText: String) -> [ParsedHunk] {
	...
	internal static func parseHunkHeader(_ line: String) -> (oldStart: Int, oldLines: Int, newStart: Int, newLines: Int)? {
	...
	internal static func truncatePatches(
	...
	internal static func countChanges(in patchText: String) -> (insertions: Int, deletions: Int) {
		var insertions = 0
		var deletions = 0
	...
	internal static func toDiffFileDTO(
	...
	internal struct ChangedLine: Sendable, Equatable {
		internal let path: String
		internal let lineNumber: Int
		internal let changeType: Character  // "+" or "-"
		internal let content: String
	}
	...
	internal static func extractChangedLines(from perFilePatches: [String: String]) -> [ChangedLine] {
	...
	internal static func buildChangedLinesTsv(from perFilePatches: [String: String]) -> String {
