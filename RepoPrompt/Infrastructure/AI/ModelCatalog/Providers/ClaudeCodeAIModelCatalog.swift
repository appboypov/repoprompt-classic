...
enum ClaudeCodeAIModelCatalog {
	...
	static func compatibleBackendDescriptor(for model: AIModel) -> CompatibleBackendModelDescriptor? {
		guard case .claudeCodeModel(let specifier) = model else { return nil }
	...
	private static func legacyModel(forBaseModelRaw raw: String) -> AIModel? {
		...
		case "opus": return .claudeCodeOpus
		case "sonnet": return .claudeCodeSonnet
		case "haiku": return .claudeCodeHaiku
		default: return nil
		}
	}
	...
	private static func compatibleBackendID(forAlias alias: String) -> ClaudeCodeCompatibleBackendID? {
		...
		case compatibleBackendAlias(for: .glmZAI): return .glmZAI
		case compatibleBackendAlias(for: .kimi): return .kimi
		case compatibleBackendAlias(for: .custom): return .custom
		default: return nil
		}
	}
	...
	private static func canonicalAgentCatalogEffortSpecifier(_ rawSpecifier: String) -> String? {
		...
		guard let baseModel = parsed.baseModel,
			let effort = parsed.explicitEffortLevel else {
			return nil
		}
