...
struct OpenCodeAgentConfig: Sendable {
	enum ToolProfile: Sendable, Equatable {
		case agentMode
		case headless
		case noTools
		...
		var sessionModeID: String {
			...
			case .headless:
				return OpenCodeAgentConfig.managedHeadlessSessionModeID
			case .noTools:
				return OpenCodeAgentConfig.managedNoToolsSessionModeID
			}
		}
	}
