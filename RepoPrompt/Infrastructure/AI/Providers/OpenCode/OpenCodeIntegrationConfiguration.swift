...
enum OpenCodeIntegrationConfiguration {
	...
	/// RepoPrompt-managed OpenCode mode used by headless discovery/delegate-edit paths. It
	...
	static var managedHeadlessAgentConfigDict: [String: Any] {
		[
			...
			"description": "RepoPrompt-managed no-native-tools mode for headless discovery and delegate edit runs.",
			"mode": "primary",
	...
	private static func isLegacyRepoPromptMCPEntry(_ entry: [String: Any]) -> Bool {
		...
		let generatedNames: Set<String> = ["repoprompt_cli", "repoprompt_cli_debug", "repoprompt-mcp"]
