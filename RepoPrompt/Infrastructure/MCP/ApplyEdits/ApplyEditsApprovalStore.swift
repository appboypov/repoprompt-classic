...
struct ApplyEditsApprovalScope: Hashable, Sendable {
	let windowID: Int
	let tabID: UUID
}

struct PendingApplyEditsReview: Identifiable, Hashable, Sendable {
	let id: UUID
...
enum ApplyEditsReviewDecision: Hashable, Sendable {
	case accept
...
struct ApplyEditsApprovalSnapshot: Sendable, Equatable {
	let scope: ApplyEditsApprovalScope
