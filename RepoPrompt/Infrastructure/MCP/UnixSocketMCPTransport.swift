...
#if DEBUG
private var unixSocketMCPTransportDebugLoggingEnabled = false
...
public actor UnixSocketMCPTransport: Transport {
	...
	nonisolated private let messageStream: AsyncThrowingStream<Data, Swift.Error>
	...
	nonisolated private let closeStream: AsyncStream<Void>
	...
	public init(
		...
		self.closeStream = AsyncStream(Void.self) { continuation in
			closeCont = continuation
		}
		self.closeContinuation = closeCont
	}
	...
	private struct UnixSocketWriteStalledError: Swift.Error, CustomStringConvertible, Sendable {
