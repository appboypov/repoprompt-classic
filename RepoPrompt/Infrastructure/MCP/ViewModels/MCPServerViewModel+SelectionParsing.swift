...
extension MCPServerViewModel {
	struct ManageSelectionInputs {
		let paths: [String]
		let sliceInputs: [RepoFileManagerViewModel.SelectionSliceInput]
		let sliceErrors: [String]
		let hadExplicitSliceSpec: Bool
	}

	static nonisolated func isLineRangeSuffix(_ suffix: Substring) -> Bool {
	...
	nonisolated func parseManageSelectionInputs(rawPaths: [String], slicesValue: Value?) -> ManageSelectionInputs {
		...
		var sliceInputs: [RepoFileManagerViewModel.SelectionSliceInput] = []
	...
	static nonisolated func parseLineRangeTokens(from text: String) -> ([LineRange], [String]) {
		let compact = text
