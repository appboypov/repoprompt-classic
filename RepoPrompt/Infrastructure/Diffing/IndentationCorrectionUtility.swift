 ...
 */
fileprivate struct IndentCache {
	let rawLines: [String]
...
class IndentCorrectionUtility {
	...
	static func reIndentUsingSearchBlock(
		...
		let sanitizedSearch  = absorbLeakedLeadingIndent(in: promotedSearch,
															fileIndentType: oldType,
															indentUnit: effectiveUnit)
		let sanitizedSnippet = absorbLeakedLeadingIndent(in: promotedSnippet,
															fileIndentType: oldType,
															indentUnit: effectiveUnit)
