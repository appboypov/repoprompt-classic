...
extension String {
	func similarity(to other: String) -> Double {
		return similarityFast(to: other)
	}
	...
	func similarityFast(to other: String) -> Double {
		return self.withCString { aPtr in
	...
	public static func encodeIndentationAsTabs(_ line: String) -> String {
	...
	public static func encodeIndentation(_ line: String, fallbackIndentationType: String = "s") -> String {
	...
	public static func encodeIndentationWithConversion(_ line: String, desiredIndentationType: String = "s") -> String {
		...
		func encodeTag(_ count: Int, content: String = "") -> String {
			return "<\(desiredIndentationType)\(count)>" + content
		}
		...
		if trimmed.isEmpty {
			if desiredIndentationType == "s" {
				if isTabBased {
					...
					let tabCount = originalIndentation.filter { $0 == "\t" }.count
	...
	public static func encodeIndentationAsSpacesPreservingLineEndings(_ text: String) -> String {
	...
	public static func encodeIndentationAsSpaces(_ line: String) -> String {
	...
	public static func decodeIndentation(_ encodedLine: String) -> String {
	...
	public static func decodeIndentationPreservingAllLineEndings(_ content: String) -> String {
	...
	public static func trimCommonLeadingWhitespacePreservingLineEndings(_ content: String) -> String {
	...
	public static func getIndentationEncoding(from encodedLine: String) -> (type: String, count: Int) {
	...
	public static func detectIndentationTypeFromEncodedLines(_ lines: [String]) -> (type: String, size: Int) {
		for line in lines {
	...
	public static func removeIndentationTag(_ encodedLine: String) -> String {
		// Only split if there’s an actual '>' in the first few characters
		guard encodedLine.hasPrefix("<s") || encodedLine.hasPrefix("<t"),
				let closeIndex = encodedLine.firstIndex(of: ">") else {
			return encodedLine
		}
	...
	public static func detectIndentationTypeFromLines(_ lines: [String]) -> (type: String, size: Int) {
		var tabCount = 0
		var spaceCount = 0
		var spaceSizes: [Int] = []
	...
	public static func detectIndentationType(_ content: String) -> (type: String, size: Int) {
	...
	func ranges(of substring: String, options: String.CompareOptions = []) -> [Range<Index>] {
		...
		while startIndex < self.endIndex,
				let range = self.range(of: substring, options: options, range: startIndex..<self.endIndex) {
			ranges.append(range)
	...
	public static func getIndentationLevel(from line: String) -> Int {
		guard let match = indentationLevelRegex.firstMatch(in: line, range: NSRange(line.startIndex..., in: line)),
				let countRange = Range(match.range(at: 2), in: line) else {
			return 0
		}
	...
	public static func applyIndentationDelta(to line: String, delta: Int) -> String {
	...
	public static func computeIndentationDeltaForBlocks(_ source: [String], _ target: [String]) -> Int {
	...
	public static func applyIndentationDeltaToBlock(_ lines: [String], _ delta: Int) -> [String] {
		return lines.map { line in
			return String.applyIndentationDelta(to: line, delta: delta)
		}
	}
	
	/// If snippet uses tabs and file uses spaces (or vice versa), convert.
	public static func matchIndentation(_ line: String, snippetIndentType: String, fileIndentType: String) -> String {
	...
	public static func convertTabsToSpaces(_ line: String) -> String {
	...
	public static func convertSpacesToTabs(_ line: String) -> String {
		let decoded = String.decodeIndentation(line)
	...
	public static func computeTwoStageIndentationDelta(
		source: [String],
		snippet: [String]
	...
	public static func applyTwoStageIndentationDeltaToBlock(
		_ lines: [String],
		topLineDelta: Int,
		blockDelta: Int
	) -> [String] {
	...
	/**
		...
		*/
	public static func snippetCollapsedMultiLevels(
		original: [String],
		transformed: [String]
	) -> Bool {
	...
	public static func findClosestPath(_ requested: String, among allowed: [String]) -> String? {
		// 1) Direct exact match
	...
	*/
	...
	func isFuzzyMatch(to other: String, threshold: Double = 0.65) -> Bool {
		if self.range(of: other, options: .caseInsensitive) != nil { return true }
		if abs(self.count - other.count) > 6 { return false }
	...
	func fuzzySpaceMatch(_ text: String, caseInsensitive: Bool = false) -> Bool {
		return self.withCString { patternPtr in
	...
	private static let encodedIndentRegex: NSRegularExpression = {
		return try! NSRegularExpression(pattern: #"^<([st])(\d+)>(.*)$"#)
	}()
	...
	///   "<t1>\\tbar"     → "<t2>bar"
	///   "<s4>\\u0009baz" → "<s8>baz"
	public static func promoteEscapedTabsInEncodedLine(_ line: String, spacesTabStop: Int = 4, enabled: Bool = true) -> String {
	...
	public static func promoteEscapedTabsInEncodedLines(_ lines: [String], spacesTabStop: Int = 4, enabled: Bool = true) -> [String] {
	...
	public static func shouldPromoteLeadingEscapedTabs(
		path: String,
		...
		func hasLaTeXMarkers(_ s: String) -> Bool {
			return s.contains("\\documentclass")
	...
	public static func findLinesWithLeadingEscapedTabs(_ lines: [String]) -> [Int] {
		var bad: [Int] = []
	...
	func slice(from offset: Int = 0, length: Int? = nil) -> String {
		...
		if let length = length, length >= 0 {
			...
			let endIdx = index(startIdx, offsetBy: length,
