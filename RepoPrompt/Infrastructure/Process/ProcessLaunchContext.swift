...
enum ProcessLaunchSource: Equatable, Sendable {
	case launchServices
	case xcode
...
struct ProcessLaunchContext: Equatable, Sendable {
	...
	static func detect(from environment: [String: String] = ProcessInfo.processInfo.environment) -> ProcessLaunchContext {
		let source: ProcessLaunchSource
		if environment[launchSourceEnvironmentKey] == launchServicesEnvironmentValue {
