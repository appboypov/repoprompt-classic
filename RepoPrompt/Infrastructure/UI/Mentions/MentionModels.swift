...
public struct MentionSuggestion: Identifiable, Equatable {
    ...
    public var children: [MentionSuggestion]? = nil
    public var subtitle: String? = nil      // Optional secondary text (e.g. skill description)
    public var commitDisplayText: String? = nil // Text inserted after resolving a plain-text @ tag
}
