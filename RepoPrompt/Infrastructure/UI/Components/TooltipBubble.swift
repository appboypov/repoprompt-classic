...
struct TooltipBubble: View {
	...
	private var maxWidth: CGFloat { 320 * preset.scaleFactor }
...
private struct HoverTooltipModifier: ViewModifier {
	...
	@AppStorage(SettingKeys.showTooltips) private var showTooltips: Bool = true
	private var preset: FontScalePreset { .current }
