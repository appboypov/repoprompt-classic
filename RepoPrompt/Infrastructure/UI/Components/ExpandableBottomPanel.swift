...
struct ExpandableBottomPanel<Header: View, Content: View>: View {
	...
	init(
		...
		self._expandedBodyHeight = expandedBodyHeight
...
extension ExpandableBottomPanel {
	init(
		...
		self._isExpanded = isExpanded
		self._collapsedHeight = collapsedHeight
		self._expandedBodyHeight = .constant(fixedBodyHeight)
		self.minBodyHeight = fixedBodyHeight
		self.maxBodyHeight = fixedBodyHeight
		self.expandedMinWidth = expandedMinWidth
		self.showsDividerWhenExpanded = showsDividerWhenExpanded
		self.cornerRadius = cornerRadius
