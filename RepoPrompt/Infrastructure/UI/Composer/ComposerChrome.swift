...
struct ComposerChrome<Main: View, Strip: View>: View {
	static var baseBarHeight: CGFloat { 60 }
	...
	var bubbleHorizontalPaddingOverride: CGFloat? = nil
	var bubbleVerticalPaddingOverride: CGFloat? = nil
	var bubbleInnerSpacingOverride: CGFloat? = nil
	var controlStripHeightOverride: CGFloat? = nil
	...
	var bubbleHorizontalPadding: CGFloat { bubbleHorizontalPaddingOverride ?? 12 }
	var bubbleVerticalPadding: CGFloat { bubbleVerticalPaddingOverride ?? (8 * fontPreset.scaleFactor) }
	var bubbleInnerSpacing: CGFloat { bubbleInnerSpacingOverride ?? (2 * fontPreset.scaleFactor) }
	var controlStripHeight: CGFloat { controlStripHeightOverride ?? max(40, 40 * fontPreset.scaleFactor) }
	var dividerHeight: CGFloat { 1 }
	var bubbleBottomPadding: CGFloat { 8 }
	var minBarHeight: CGFloat { Self.baseBarHeight }
