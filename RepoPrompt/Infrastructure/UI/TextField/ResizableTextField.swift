...
struct ResizableTextFieldFeatures {
	...
	var fileTagFileManager: RepoFileManagerViewModel? = nil
	var onFileTagCommitted: ((MentionSuggestion) -> Void)? = nil
	var enableSlashSkillOverlay: Bool = false
	var slashSkillSuggestionsProvider: ((String) async -> [MentionSuggestion])? = nil

	static let chatInputBar = ResizableTextFieldFeatures()

	static func agentInputBar(
		fileTagFileManager: RepoFileManagerViewModel?,
		...
		ResizableTextFieldFeatures(
			...
			fileTagFileManager: fileTagFileManager,
...
struct ResizableTextField: View {
	...
	var features: ResizableTextFieldFeatures = .chatInputBar
...
struct CustomTextField: NSViewRepresentable {
	...
	func makeNSView(context: Context) -> NSScrollView {
		...
		context.coordinator.configureFileTagSupport(
			...
			fileManager: features.fileTagFileManager
		)
	...
	class Coordinator: NSObject, NSTextViewDelegate {
		...
		func configureFileTagSupport(
			...
			fileTagHelper.configure(textView: textView, enabled: enabled, fileManager: fileManager)
		}
