...
enum AgentModelSelectionWarningVisuals {
	...
	static func showsWarning(agent: DiscoverAgentKind, rawModel: String?) -> Bool {
		agent == .codexExec && CodexServiceTierVariantCatalog.isFastVariant(rawModel: rawModel)
	}

	static func stableMenuImageSystemName(agent: DiscoverAgentKind, rawModel: String?) -> String? {
		showsWarning(agent: agent, rawModel: rawModel) ? iconSystemName : nil
	}

	static func stableMenuStyle(agent: DiscoverAgentKind, rawModel: String?) -> StableMenuItemStyle {
...
struct AgentModelOptionsMenuContent: View {
	...
	let onSelect: (DiscoverAgentKind, AgentModelOption) -> Void
...
enum AgentModelStableMenuItems {
	static func agentSubmenu(
		...
		onSelect: @escaping (DiscoverAgentKind, AgentModelOption) -> Void
	) -> StableMenuItem {
