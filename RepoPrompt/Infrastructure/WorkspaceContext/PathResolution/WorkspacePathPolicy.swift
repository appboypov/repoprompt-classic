...
struct WorkspaceRootRef: Sendable, Hashable {
	let id: UUID
	let name: String
	let fullPath: String
...
enum RootAliasResolution: Sendable, Equatable {
...
struct RootAliasOptions: Sendable {
...
enum PathResolutionIssue: Sendable, Equatable {
	case emptyInput
